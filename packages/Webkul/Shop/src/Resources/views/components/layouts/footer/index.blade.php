...
<footer class="mt-9 bg-lightOrange max-sm:mt-10">
    <div class="flex justify-between gap-x-6 gap-y-8 p-[60px] max-1060:flex-col-reverse max-md:gap-5 max-md:p-8 max-sm:px-4 max-sm:py-5">
        <!-- Bloque personalizado de contacto y redes sociales -->
        <div class="w-[60%] max-md:w-full ml-[60px] py-6 border-b border-gray-200 mb-6">
            <div class="flex justify-between items-start flex-wrap gap-6 max-md:gap-4">
                <!-- Columna izquierda: información de contacto -->
                <div class="flex flex-col gap-2 text-gray-700">
                    <h3 class="text-xl font-semibold text-navyBlue mb-2">Contáctanos</h3>

                    <p class="flex items-center gap-2 hover:text-blue-700 transition-all">
                        <i class="fa-solid fa-phone text-orange-500 text-lg"></i>
                        <span><strong>Teléfono:</strong> 941 981 019</span>
                    </p>
                    ...
                    <p class="flex items-center gap-2 hover:text-blue-700 transition-all">
                        ...
                        <span>
                            <strong>Email:</strong>
                            <a href="mailto:contacto@tutienda.com" class="text-gray-700 hover:text-blue-700">
                    ...
                    <p class="flex items-center gap-2 hover:text-blue-700 transition-all">
                        <i class="fa-solid fa-location-dot text-orange-500 text-lg"></i>
                        <span><strong>Dirección:</strong> jr. Ayacucho # 146</span>
                    </p>
                </div>

                <!-- Columna derecha: redes sociales -->
                <div class="flex flex-col items-center gap-3 text-center redes-sociales" style="margin-left: 80px;">
                    <h3 class="text-xl font-semibold text-navyBlue mb-2">Síguenos en Redes</h3>
                    <div class="flex justify-center gap-6 text-3xl">
                        <!-- Facebook -->
                        <a href="https://www.facebook.com/share/1MYDZ6FLq1/" target="_blank" class="text-blue-600 hover:text-blue-800">
                            <i class="fab fa-facebook-f"></i>
                        </a>
                        <!-- Instagram -->
                        <a href="https://www.instagram.com/redeshard_oficial?igsh=azZsMzBhbjJkeTNp" target="_blank" class="text-pink-500 hover:text-pink-700">
                            <i class="fab fa-instagram"></i>
                        </a>
                        <!-- TikTok -->
                        <a href="https://www.tiktok.com/@redeshard_oficial?_t=ZM-90lZYl56KdA&_r=1" target="_blank" class="text-black hover:text-gray-700">
