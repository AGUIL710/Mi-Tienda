    ...
    <script type="text/x-template" id="v-mobile-drawer-template">
        ...
        >
            ...
            <x-slot:content class="!p-0">
                ...
                <!-- 🔹 Enlace: Servicios -->
                <div class="border-b border-zinc-200 py-4 px-6">
                    <a href="{{ route('shop.home.servicios') }}" class="block text-base font-medium hover:text-navyBlue transition">
                        SERVICIOS
                    </a>
                </div>

                <!-- 🔹 Categorías (Bagisto) + Enlaces adicionales -->
                <div class="border-b border-zinc-200">
                    ...
                    <!-- Enlaces debajo de las categorías -->
                    <div class="border-t border-zinc-200 px-6 pt-3 pb-2">
                        <a href="{{ route('shop.home.nosotros') }}" class="block py-2 text-base font-medium hover:text-navyBlue transition">
                            NOSOTROS
                        </a>
                        <a href="{{ route('shop.home.contacto') }}" class="block py-2 text-base font-medium hover:text-navyBlue transition">
                            CONTACTO
                        </a>
                    </div>
                </div>
