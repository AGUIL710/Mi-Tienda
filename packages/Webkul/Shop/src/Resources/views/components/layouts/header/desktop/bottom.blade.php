...
<div class="flex min-h-[78px] w-full justify-between border border-b border-l-0 border-r-0 border-t-0 px-[60px] max-1180:px-8">
    ...
    <div class="flex items-center gap-x-10 max-[1180px]:gap-x-5">
        ...
        <div class="flex items-center gap-x-8 max-lg:hidden">
            <!-- 🔹 Tu pestaña personalizada primero -->
            <a href="{{ route('shop.home.servicios') }}" class="uppercase hover:text-navyBlue transition">
                Servicios
            </a>
            <v-desktop-category>
            ...
            <a href="{{ route('shop.home.nosotros') }}" class="uppercase hover:text-navyBlue transition">
                Nosotros
            </a>

            <a href="{{ route('shop.home.contacto') }}" class="uppercase hover:text-navyBlue transition">
                Contacto
            </a>
        </div>
