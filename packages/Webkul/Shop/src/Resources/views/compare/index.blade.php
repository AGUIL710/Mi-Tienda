                    ...
                    getItems() {
                        ...
                        this.$axios.get("{{ route('shop.api.compare.index') }}", {
                            ...
                            .then(response => {
                                ...
                                this.comparableAttributes = this.comparableAttributes.filter(attr => {
                                    if (attr.code === 'product') return true; // nunca ocultar la fila "Producto"

                                    // verificar si al menos un producto tiene dato en este atributo
                                    return this.items.some(prod => {
                                        const val = prod[attr.code];
